...
class PaymentViewSet(viewsets.ViewSet):
    ...
    @swagger_auto_schema(operation_description="Create a new payment", request_body=PaymentSerializer, responses={201: PaymentSerializer()}, operation_summary="Create a new payment")
